...
// api/node_modules/node-cron/src/task.js
var require_task = __commonJS({
  'api/node_modules/node-cron/src/task.js'(exports, module) {
    'use strict';
...
// api/node_modules/node-cron/src/convert-expression/month-names-conversion.js
...
// api/node_modules/node-cron/src/convert-expression/week-day-names-conversion.js
...
// api/node_modules/node-cron/src/convert-expression/asterisk-to-range-conversion.js
...
// api/node_modules/node-cron/src/convert-expression/range-conversion.js
...
// api/node_modules/node-cron/src/convert-expression/step-values-conversion.js
...
// api/node_modules/node-cron/src/convert-expression/index.js
...
// api/node_modules/node-cron/src/pattern-validation.js
var require_pattern_validation = __commonJS({
  'api/node_modules/node-cron/src/pattern-validation.js'(exports, module) {
    'use strict';
...
// api/node_modules/node-cron/src/time-matcher.js
var require_time_matcher = __commonJS({
  'api/node_modules/node-cron/src/time-matcher.js'(exports, module) {
    ...
    var TimeMatcher = class {
      ...
      match(date) {
        ...
        const runOnSecond = matchPattern(
          this.expressions[0],
          date.getSeconds()
        );
        const runOnMinute = matchPattern(
          this.expressions[1],
          date.getMinutes()
        );
        const runOnHour = matchPattern(this.expressions[2], date.getHours());
        const runOnDay = matchPattern(this.expressions[3], date.getDate());
        const runOnMonth = matchPattern(
          this.expressions[4],
          date.getMonth() + 1
        );
...
// api/node_modules/node-cron/src/scheduler.js
var require_scheduler = __commonJS({
  'api/node_modules/node-cron/src/scheduler.js'(exports, module) {
    'use strict';
    var EventEmitter = __require('events');
      ...
      start() {
        ...
        const matchTime = () => {
          ...
          for (let i = missedExecutions; i >= 0; i--) {
            const date = new Date(
              /* @__PURE__ */ new Date().getTime() - i * 1e3
            );
...
// api/node_modules/uuid/dist/esm-node/rng.js
...
// api/node_modules/uuid/dist/esm-node/regex.js
var regex_default;
...
// api/node_modules/uuid/dist/esm-node/validate.js
...
// api/node_modules/uuid/dist/esm-node/stringify.js
...
// api/node_modules/uuid/dist/esm-node/v1.js
...
// api/node_modules/uuid/dist/esm-node/parse.js
function parse(uuid) {
  if (!validate_default(uuid)) {
...
// api/node_modules/uuid/dist/esm-node/v35.js
...
// api/node_modules/uuid/dist/esm-node/md5.js
...
// api/node_modules/uuid/dist/esm-node/v3.js
var v3, v3_default;
var init_v3 = __esm({
  'api/node_modules/uuid/dist/esm-node/v3.js'() {
    init_v35();
...
// api/node_modules/uuid/dist/esm-node/v4.js
...
// api/node_modules/uuid/dist/esm-node/sha1.js
...
// api/node_modules/uuid/dist/esm-node/v5.js
var v5, v5_default;
var init_v5 = __esm({
  'api/node_modules/uuid/dist/esm-node/v5.js'() {
    init_v35();
...
// api/node_modules/uuid/dist/esm-node/nil.js
var nil_default;
var init_nil = __esm({
  'api/node_modules/uuid/dist/esm-node/nil.js'() {
...
// api/node_modules/uuid/dist/esm-node/version.js
...
// api/node_modules/uuid/dist/esm-node/index.js
...
// api/node_modules/node-cron/src/scheduled-task.js
var require_scheduled_task = __commonJS({
  'api/node_modules/node-cron/src/scheduled-task.js'(exports, module) {
    'use strict';
    var EventEmitter = __require('events');
...
// api/node_modules/node-cron/src/background-scheduled-task/index.js
...
// api/node_modules/node-cron/src/storage.js
var require_storage = __commonJS({
  'api/node_modules/node-cron/src/storage.js'(exports, module) {
    module.exports = (() => {
...
// api/node_modules/node-cron/src/node-cron.js
var require_node_cron = __commonJS({
  'api/node_modules/node-cron/src/node-cron.js'(exports, module) {
    'use strict';
...
// api/node_modules/nodemailer/lib/fetch/cookies.js
var require_cookies = __commonJS({
  'api/node_modules/nodemailer/lib/fetch/cookies.js'(exports, module) {
    'use strict';
...
// api/node_modules/nodemailer/package.json
var require_package = __commonJS({
  'api/node_modules/nodemailer/package.json'(exports, module) {
    module.exports = {
      name: 'nodemailer',
      version: '6.9.16',
...
// api/node_modules/nodemailer/lib/fetch/index.js
var require_fetch = __commonJS({
  'api/node_modules/nodemailer/lib/fetch/index.js'(exports, module) {
    'use strict';
...
// api/node_modules/nodemailer/lib/shared/index.js
var require_shared = __commonJS({
  'api/node_modules/nodemailer/lib/shared/index.js'(exports, module) {
    'use strict';
    var urllib = __require('url');
    ...
    module.exports.resolveContent = (data, key, callback) => {
      ...
      if (typeof content === 'object') {
        if (typeof content.pipe === 'function') {
          ...
          let parsedDataUri = module.exports.parseDataURI(
...
// api/node_modules/nodemailer/lib/mime-funcs/mime-types.js
var require_mime_types = __commonJS({
  'api/node_modules/nodemailer/lib/mime-funcs/mime-types.js'(exports, module) {
    'use strict';
    var path = __require('path');
...
// api/node_modules/nodemailer/lib/punycode/index.js
var require_punycode = __commonJS({
  'api/node_modules/nodemailer/lib/punycode/index.js'(exports, module) {
    'use strict';
...
// api/node_modules/nodemailer/lib/base64/index.js
var require_base64 = __commonJS({
  'api/node_modules/nodemailer/lib/base64/index.js'(exports, module) {
    'use strict';
...
// api/node_modules/nodemailer/lib/qp/index.js
var require_qp = __commonJS({
  'api/node_modules/nodemailer/lib/qp/index.js'(exports, module) {
    'use strict';
    var Transform = __require('stream').Transform;
    function encode(buffer) {
      if (typeof buffer === 'string') {
...
// api/node_modules/nodemailer/lib/mime-funcs/index.js
var require_mime_funcs = __commonJS({
  'api/node_modules/nodemailer/lib/mime-funcs/index.js'(exports, module) {
    'use strict';
...
// api/node_modules/nodemailer/lib/addressparser/index.js
var require_addressparser = __commonJS({
  'api/node_modules/nodemailer/lib/addressparser/index.js'(exports, module) {
    'use strict';
...
// api/node_modules/nodemailer/lib/mime-node/last-newline.js
var require_last_newline = __commonJS({
  'api/node_modules/nodemailer/lib/mime-node/last-newline.js'(exports, module) {
    'use strict';
    var Transform = __require('stream').Transform;
...
// api/node_modules/nodemailer/lib/mime-node/le-windows.js
var require_le_windows = __commonJS({
  'api/node_modules/nodemailer/lib/mime-node/le-windows.js'(exports, module) {
    'use strict';
...
// api/node_modules/nodemailer/lib/mime-node/le-unix.js
var require_le_unix = __commonJS({
  'api/node_modules/nodemailer/lib/mime-node/le-unix.js'(exports, module) {
    'use strict';
    var stream = __require('stream');
    var Transform = stream.Transform;
    var LeWindows = class extends Transform {
...
// api/node_modules/nodemailer/lib/mime-node/index.js
var require_mime_node = __commonJS({
  'api/node_modules/nodemailer/lib/mime-node/index.js'(exports, module) {
    'use strict';
    ...
    var MimeNode = class _MimeNode {
      constructor(contentType, options) {
        ...
        options = options || {};
        this.baseBoundary =
          options.baseBoundary || crypto4.randomBytes(8).toString('hex');
      ...
      _generateMessageId() {
        return (
          ...
          [2, 2, 2, 6].reduce(
            ...
            (prev, len) =>
              prev + '-' + crypto4.randomBytes(len).toString('hex'),
...
// api/node_modules/nodemailer/lib/mail-composer/index.js
var require_mail_composer = __commonJS({
  'api/node_modules/nodemailer/lib/mail-composer/index.js'(exports, module) {
    'use strict';
...
// api/node_modules/nodemailer/lib/dkim/message-parser.js
var require_message_parser = __commonJS({
  'api/node_modules/nodemailer/lib/dkim/message-parser.js'(exports, module) {
    'use strict';
    var Transform = __require('stream').Transform;
...
// api/node_modules/nodemailer/lib/dkim/relaxed-body.js
var require_relaxed_body = __commonJS({
  'api/node_modules/nodemailer/lib/dkim/relaxed-body.js'(exports, module) {
    'use strict';
    var Transform = __require('stream').Transform;
    var crypto4 = __require('crypto');
...
// api/node_modules/nodemailer/lib/dkim/sign.js
var require_sign = __commonJS({
  'api/node_modules/nodemailer/lib/dkim/sign.js'(exports, module) {
    'use strict';
    var punycode = require_punycode();
    var mimeFuncs = require_mime_funcs();
    var crypto4 = __require('crypto');
...
// api/node_modules/nodemailer/lib/dkim/index.js
var require_dkim = __commonJS({
  'api/node_modules/nodemailer/lib/dkim/index.js'(exports, module) {
    'use strict';
        ...
        this.cachePath = this.cacheDir
          ? path.join(
              ...
              'message.' +
                Date.now() +
                '-' +
                crypto4.randomBytes(14).toString('hex')
            )
          : false;
        this.cache = false;
        this.headers = false;
...
// api/node_modules/nodemailer/lib/smtp-connection/http-proxy-client.js
...
// api/node_modules/nodemailer/lib/mailer/mail-message.js
var require_mail_message = __commonJS({
  'api/node_modules/nodemailer/lib/mailer/mail-message.js'(exports, module) {
    'use strict';
    var shared = require_shared();
    var MimeNode = require_mime_node();
    var mimeFuncs = require_mime_funcs();
...
// api/node_modules/nodemailer/lib/mailer/index.js
var require_mailer = __commonJS({
  'api/node_modules/nodemailer/lib/mailer/index.js'(exports, module) {
    'use strict';
    var EventEmitter = __require('events');
    var shared = require_shared();
    var mimeTypes = require_mime_types();
          ...
          html = (html || '')
            ...
            .replace(
              ...
              (match, prefix, dataUri, mimeType) => {
                let cid =
                  crypto4.randomBytes(10).toString('hex') + '@localhost';
...
// api/node_modules/nodemailer/lib/smtp-connection/data-stream.js
...
// api/node_modules/nodemailer/lib/smtp-connection/index.js
var require_smtp_connection = __commonJS({
  'api/node_modules/nodemailer/lib/smtp-connection/index.js'(exports, module) {
    'use strict';
    ...
    var SMTPConnection = class extends EventEmitter {
      ...
      _actionAUTH_CRAM_MD5(str, callback) {
        ...
        let base64decoded = Buffer.from(challengeString, 'base64').toString(
          ...
          hmacMD5 = crypto4.createHmac('md5', this._auth.credentials.pass);
...
// api/node_modules/nodemailer/lib/xoauth2/index.js
var require_xoauth2 = __commonJS({
  'api/node_modules/nodemailer/lib/xoauth2/index.js'(exports, module) {
    'use strict';
...
// api/node_modules/nodemailer/lib/smtp-pool/pool-resource.js
...
// api/node_modules/nodemailer/lib/well-known/services.json
var require_services = __commonJS({
  'api/node_modules/nodemailer/lib/well-known/services.json'(exports, module) {
    module.exports = {
      '1und1': {
        host: 'smtp.1und1.de',
        port: 465,
...
// api/node_modules/nodemailer/lib/well-known/index.js
var require_well_known = __commonJS({
  'api/node_modules/nodemailer/lib/well-known/index.js'(exports, module) {
    'use strict';
...
// api/node_modules/nodemailer/lib/smtp-pool/index.js
var require_smtp_pool = __commonJS({
  'api/node_modules/nodemailer/lib/smtp-pool/index.js'(exports, module) {
    'use strict';
    var EventEmitter = __require('events');
...
// api/node_modules/nodemailer/lib/smtp-transport/index.js
var require_smtp_transport = __commonJS({
  'api/node_modules/nodemailer/lib/smtp-transport/index.js'(exports, module) {
    'use strict';
    var EventEmitter = __require('events');
    var SMTPConnection = require_smtp_connection();
    var wellKnown = require_well_known();
...
// api/node_modules/nodemailer/lib/sendmail-transport/index.js
...
// api/node_modules/nodemailer/lib/stream-transport/index.js
var require_stream_transport = __commonJS({
  'api/node_modules/nodemailer/lib/stream-transport/index.js'(exports, module) {
    'use strict';
    var packageData = require_package();
    var shared = require_shared();
...
// api/node_modules/nodemailer/lib/json-transport/index.js
var require_json_transport = __commonJS({
  'api/node_modules/nodemailer/lib/json-transport/index.js'(exports, module) {
    'use strict';
    var packageData = require_package();
    var shared = require_shared();
...
// api/node_modules/nodemailer/lib/ses-transport/index.js
var require_ses_transport = __commonJS({
  'api/node_modules/nodemailer/lib/ses-transport/index.js'(exports, module) {
    'use strict';
    var EventEmitter = __require('events');
    var packageData = require_package();
    var shared = require_shared();
...
// api/node_modules/nodemailer/lib/nodemailer.js
var require_nodemailer = __commonJS({
  'api/node_modules/nodemailer/lib/nodemailer.js'(exports, module) {
    'use strict';
    ...
    module.exports.createTransport = function (transporter2, defaults) {
      ...
      if (
        ...
        (typeof transporter2 === 'object' &&
          typeof transporter2.send !== 'function') || // provided transporter looks like a connection url
        (typeof transporter2 === 'string' &&
          /^(smtps?|direct):/i.test(transporter2))
      ) {
        if (
          (urlConfig =
            typeof transporter2 === 'string' ? transporter2 : transporter2.url)
        ) {
